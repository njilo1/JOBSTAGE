...
class _FavoritesScreenState extends State<FavoritesScreen>
  ...
  final List<Map<String, dynamic>> favoriteCompanies = [
    {
      ...
      'rating': 4.7,
      'description':
          'Entreprise leader dans le développement d\'applications mobiles au Cameroun',
    ...
    },
    {
      ...
      'rating': 4.5,
      'description':
          'Agence spécialisée dans le marketing digital et la communication',
      'addedToFavorites': '11 Sep 2024',
    },
    {
      'name': 'Data Solutions',
      ...
      'rating': 4.8,
      'description':
          'Entreprise spécialisée dans l\'analyse de données et l\'intelligence artificielle',
  ...
  Widget _buildTrainingsList() {
    if (favoriteTrainings.isEmpty) {
      return _buildEmptyState(
        ...
        'Ajoutez des formations à vos favoris pour les retrouver ici',
      );
    }
  ...
  Widget _buildCompaniesList() {
    if (favoriteCompanies.isEmpty) {
      return _buildEmptyState(
        'Aucune entreprise favorite',
        'Ajoutez des entreprises à vos favoris pour les retrouver ici',
      );
    }
      ...
      child: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border(
              left: BorderSide(color: AppColors.formationIconColor, width: 5),
            ),
          ),
          padding: const EdgeInsets.all(15),
          child: Column(
      ...
      child: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border(
              left: BorderSide(color: AppColors.orangeDark, width: 5),
            ),
          ),
          padding: const EdgeInsets.all(15),
          child: Column(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDetailSection(
                        'Postes ouverts',
                        '${company['openPositions']} postes disponibles',
                      ),
                      _buildDetailSection('Note', '${company['rating']}/5 ⭐'),
                      _buildDetailSection(
                        'Ajouté aux favoris',
                        company['addedToFavorites'],
                      ),
                      _buildDetailSection(
                        'Description',
                        company['description'],
