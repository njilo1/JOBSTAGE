...
class _PrivacyScreenState extends State<PrivacyScreen> {
  ...
  Widget _buildPrivacySection(String title, String subtitle, List<Widget> children) {
    return Container(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isDestructive ? Colors.red.withValues(alpha: 0.3) : AppColors.blueDark.withValues(alpha: 0.2),
            width: 1,
          ),
          boxShadow: [
            BoxShadow(
  ...
  void _resetSettings() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Paramètres réinitialisés !', style: GoogleFonts.roboto()),
        backgroundColor: AppColors.blueDark,
      ),
    );
  }
  ...
  void _downloadData() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Téléchargement de vos données...', style: GoogleFonts.roboto()),
        backgroundColor: AppColors.blueDark,
      ),
    );
  }
