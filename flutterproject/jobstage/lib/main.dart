...
class _JobstageHomePageState extends State<JobstageHomePage>
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              const SizedBox(height: 10), // Espacement du haut encore plus réduit
              ...
              const SizedBox(height: 80), // Espacement du footer 
              ...
              // Pas d'espacement du bas pour éviter le débordement
            ],
          ),
        ),
      ),
  ...
  Widget _buildHeaderSection() {
    return Column(
      children: [
        ...
        const SizedBox(height: 1), // Espacement très réduit pour rapprocher l'image du logo
        
        // Titre principal "Jobstage" - Image du nom agrandie avec Transform
        Transform.scale(
          scale: 2, // Agrandit l'image de 60% sans affecter le layout
          child: Image.asset(
            'assets/images/name.png',
            height: 100, // Taille de base
            fit: BoxFit.contain,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Transform.scale(
          scale: 0.8 + (_fadeAnimation.value * 0.3), // Animation de zoom élégante
          child: SizedBox(
            width: 220, // Logo plus grand
            height: 110, // Logo plus grand
            child: _buildImageWidget(
              'assets/images/20250909_235800_0000.png',
              fallback: Container(
  ...
  Widget _buildCustomIcon(String iconPath, IconData fallbackIcon, Color iconColor) {
    return Image.asset(
      iconPath,
      width: 28,
      height: 28,
    ...
    return Column(
      children: [
        ...
        _buildRoleCard(
          ...
          iconContainerColor: const Color(0xFFD6E4FF), // Bleu très clair pour le conteneur d'icône
        ...
        _buildRoleCard(
          ...
          iconContainerColor: const Color(0xFFCCF5D3), // Vert très clair pour le conteneur d'icône
          iconColor: const Color(0xFF2C3E50), // Couleur sombre pour la visibilité
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: _buildCustomIcon(iconPath, fallbackIcon, iconColor),
                      ),
                    ),
  ...
  void _navigateToCandidatPage() {
    Navigator.of(context).push(
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => const CandidatPage(),
  ...
  void _navigateToRecruteurPage() {
    Navigator.of(context).push(
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => const RecruteurPage(),
        transitionsBuilder: (context, animation, secondaryAnimation, child) {
          // Hero animation pour une transition fluide
          return Hero(
            tag: 'recruteur_page',
      ...
      builder: (context) => AlertDialog(
        ...
        content: RichText(
          text: TextSpan(
            ...
            children: [
              const TextSpan(
                text: "Le CENADI (Centre National de Développement Informatique) est l'institution publique camerounaise chargée de la modernisation numérique de l'administration et des services publics.\n\n"
