...
class DataService {
  ...
  final List<Entreprise> _entreprises = [
    Entreprise(
      ...
      description: 'Entreprise spécialisée dans le développement de solutions technologiques innovantes pour le marché camerounais et africain. Nous développons des applications mobiles, des solutions web et des systèmes de gestion d\'entreprise.',
  ...
  final List<Offre> _offres = [
    Offre(
      ...
      description: 'Nous recherchons un développeur Flutter expérimenté pour rejoindre notre équipe de développement mobile.',
      ...
      avantages: ['Assurance santé', 'Formation continue', 'Télétravail partiel'],
    ...
    Offre(
      ...
      description: 'Stage de 6 mois en marketing digital pour un étudiant motivé.',
      secteurActivite: 'Marketing',
      competencesRequises: ['Marketing Digital', 'Social Media', 'Google Ads', 'Analytics'],
      localisation: 'Douala',
      typeContrat: 'Stage',
  ...
  final List<Candidat> _candidats = [
    Candidat(
      ...
      competences: ['Flutter', 'Dart', 'Firebase', 'Git', 'API REST', 'JavaScript'],
      experiences: ['Développeur Mobile - 2 ans', 'Stagiaire Développement - 6 mois'],
    ...
    Candidat(
      ...
      competences: ['Flutter', 'React Native', 'JavaScript', 'Node.js', 'MongoDB'],
    ...
    Candidat(
      ...
      competences: ['Marketing Digital', 'Social Media', 'Google Ads', 'Analytics', 'Content Creation'],
  ...
  List<Candidat> getCandidatsRecommandes(String offreId) {
    ...
    return _candidats
        .where((c) => c.domaineEtude == offre.secteurActivite || 
                     c.competences.any((comp) => offre.competencesRequises.contains(comp)))
        .toList()
      ..sort((a, b) => b.scoreMatching.compareTo(a.scoreMatching));
  }

  List<NotificationModel> getNotificationsByDestinataire(String destinataireId) {
  ...
  Map<String, int> getStatistiquesEntreprise(String entrepriseId) {
    ...
    final totalCandidats = offresEntreprise.fold(0, (sum, o) => sum + o.nombreCandidats);
    final totalCandidatures = offresEntreprise.fold(0, (sum, o) => sum + o.nombreCandidatures);
