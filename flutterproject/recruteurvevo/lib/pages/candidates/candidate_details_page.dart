...
class _CandidateDetailsPageState extends State<CandidateDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppTheme.customColors['surface_bg'] ?? Colors.grey[100],
      appBar: AppBar(
      ...
      child: Column(
        children: [
          CircleAvatar(
            ...
            child: Text(
              widget.candidat.nomComplet.split(' ').map((name) => name[0]).join(''),
          ...
          Text(
            ...
            style: AppTheme.headlineMedium.copyWith(
              ...
              color: AppTheme.customColors['primary_text'] ?? Colors.black,
            ),
          ),
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: AppTheme.labelSmall.copyWith(
                    color: widget.candidat.isActif ? Colors.green : Colors.orange,
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    _buildInfoRow('Niveau d\'études', widget.candidat.niveauEtudeAffichage, Icons.school),
                    _buildInfoRow('Année de diplôme', '${widget.candidat.anneeDiplome}', Icons.calendar_today),
                    _buildInfoRow('Université', widget.candidat.universite, Icons.location_city),
                    _buildInfoRow('Expérience', widget.candidat.experienceAffichage, Icons.work),
                  ],
                ),
              ),
            ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildFormationItem('${widget.candidat.niveauEtudeAffichage}', widget.candidat.universite, '${widget.candidat.anneeDiplome - 3}-${widget.candidat.anneeDiplome}'),
                  ],
                ),
              ),
            ),
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    _buildContactRow(Icons.phone, 'Téléphone', widget.candidat.telephone),
                    _buildContactRow(Icons.email, 'Email', widget.candidat.email),
                    // LinkedIn simulé
                    _buildContactRow(Icons.link, 'LinkedIn', 'linkedin.com/in/${widget.candidat.nom.toLowerCase()}-${widget.candidat.prenom.toLowerCase()}'),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildFormationItem(String diplome, String etablissement, String periode) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Ouverture de l\'application email pour ${widget.candidat.email}'),
