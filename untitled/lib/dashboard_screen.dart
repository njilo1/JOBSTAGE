...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _toggleFavorite(String jobTitle) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: favorites[jobTitle]! ? AppColors.greenDark : Colors.grey,
      ),
    );
  }

  void _showJobDetails(String title, String company, String location, String type, String time, String match, bool isJob, {String? salary}) {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDetailRow('Compétences requises', 
                        '• Flutter et Dart\n• Firebase\n• API REST\n• Git\n• Travail en équipe'
                      ),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Email envoyé à support@jobstage.cm')),
                  );
                },
  ...
  Widget _buildAppHeader() {
    return Container(
      ...
      child: Padding(
        padding: const EdgeInsets.fromLTRB(20, 0, 20, 10), // Espace réduit pour un header plus compact
        child: Column(
          children: [
            // Header top row with logo and icons
            Transform.translate(
              offset: const Offset(0, -15), // Réduit l'offset pour un header plus compact
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                // Logo
                Image.asset(
                  ...
                  height: 100, // Réduit la taille du logo pour un header plus compact
                  fit: BoxFit.contain,
                ...
                // Icon group
                Padding(
                  padding: const EdgeInsets.only(top: 0), // Supprime l'espace au-dessus des icônes
                  child: Row(
                    children: [
                      GestureDetector(
            ...
            Transform.translate(
              offset: const Offset(0, -25), // Réduit l'offset pour un header plus compact
              child: Align(
  ...
  Widget _buildJobCard(
    ...
    return GestureDetector(
      onTap: () => _showJobDetails(title, company, location, type, time, matchScore, isJob, salary: _getSalaryForJob(title)),
      child: Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(16),
              ...
              Expanded(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Icon(
                      favorites[title] == true ? Icons.bookmark : Icons.bookmark_border,
                      color: favorites[title] == true ? AppColors.favorisIconColor : AppColors.secondaryText,
                      size: 24,
                    ),
                  ),
      ...
      children: [
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const ApplicationsScreen())),
              child: Text(
                'Tout voir',
                style: GoogleFonts.roboto(
                  fontSize: 14,
