            ...
            children: [
                ...
                child: Column(
                  children: [
                    _buildCompactDropdown(
                      selectedJobType,
                      ['Temps plein', 'Temps partiel', 'Freelance', 'Stage', 'Contrat', 'Autre'],
                      (value) {
                        setState(() {
              ...
              _buildPreferenceCard(
                ...
                child: _buildCompactDropdown(
                  ...
                  ['Débutant (0-1 an)', 'Junior (1-3 ans)', 'Intermédiaire (3-5 ans)', 'Senior (5+ ans)'],
              ...
              _buildPreferenceCard(
                ...
                child: Transform.scale(
                  ...
                  child: Switch(
                    ...
                    activeTrackColor: const Color(0xFF007bff).withOpacity(0.3),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          onChanged: onChanged,
          icon: const Icon(Icons.keyboard_arrow_down, color: Color(0xFF007bff), size: 24),
