                  ...
                  (value) async {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        ...
                        backgroundColor: value ? Colors.grey[800] : AppColors.blueDark,
                      ),
                    );
                  },
                ),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.language, color: AppColors.blueDark, size: 20),
              ),
              const SizedBox(width: 15),
              Expanded(
                child: Column(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.lock_outline, color: AppColors.blueDark),
                    ),
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Message envoyé ! Nous vous répondrons bientôt.'),
                  backgroundColor: AppColors.greenDark,
                ),
              );
            },
