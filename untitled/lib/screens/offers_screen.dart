...
class _OffersScreenState extends State<OffersScreen> {
  ...
  final List<String> filters = [
    'Tous', 'Emplois', 'Stages', 'CDI', 'CDD', 'Stage 6 mois', 
    'Stage académique', 'Stage libre', 'Yaoundé', 'Douala', 'Bafoussam', 
    'Récent', 'Match élevé', 'Freelance', 'Temps partiel', 'Télétravail'
  ];
  ...
  List<Map<String, dynamic>> get filteredOffers {
    ...
    Set<String> contractFilters = selectedFilters.intersection({'CDI', 'CDD', 'Stage 6 mois', 'Stage académique', 'Stage libre', 'Freelance', 'Temps partiel'});
    ...
    Set<String> locationFilters = selectedFilters.intersection({'Yaoundé', 'Douala', 'Bafoussam', 'Télétravail'});
    ...
    if (selectedFilters.contains('Match élevé')) {
      filtered.sort((a, b) => int.parse(b['match'].replaceAll('%', '')).compareTo(int.parse(a['match'].replaceAll('%', ''))));
    }
  ...
  void _toggleFilter(String filter) {
    setState(() {
      if (filter == 'Tous') {
        ...
        selectedFilters.remove('Tous'); // Retirer "Tous" si on sélectionne autre chose
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (selectedFilters.isNotEmpty && !selectedFilters.contains('Tous'))
                      Padding(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Padding(
                            ...
                            child: FilterChip(
                              ...
                              side: BorderSide(
                                color: isSelected ? AppColors.blueDark : AppColors.blueLight,
                              ),
                            ),
                          );
                        },
          ...
          children: [
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Icon(
                        ...
                        color: offer['isFavorite'] ? AppColors.favorisIconColor : AppColors.secondaryText,
                        size: 24,
                      ),
                    ),
            ...
            Row(
              children: [
                Expanded(
                  flex: 1,
                  child: _buildDetailChip(Icons.pin_drop, offer['location'], AppColors.orangeDark),
                ),
                Expanded(
                  flex: 1,
                  child: _buildDetailChip(Icons.description, offer['type'], AppColors.blueDark),
                ),
                Expanded(
                  flex: 1,
                  child: _buildDetailChip(Icons.schedule, offer['time'], Colors.grey),
                ),
              ],
            ),
          ],
