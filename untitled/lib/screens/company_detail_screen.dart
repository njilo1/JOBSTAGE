  ...
  final List<Map<String, dynamic>> companyOffers = [
    {
      ...
      'isJob': true,
      'isFavorite': false,
      'description': 'Nous recherchons un développeur passionné pour rejoindre notre équipe dynamique. Vous travaillerez sur des projets innovants et aurez l\'opportunité de développer vos compétences dans un environnement stimulant.',
      'requirements': ['Flutter et Dart', 'Firebase', 'API REST', 'Git', 'Travail en équipe'],
    ...
    },
    {
      ...
      'isJob': true,
      'isFavorite': true,
      'description': 'Poste junior pour un développeur Flutter débutant souhaitant évoluer dans le développement mobile.',
      'requirements': ['Connaissance de base Flutter', 'Motivation', 'Esprit d\'équipe'],
    ...
    },
    {
      ...
      'isJob': false,
      'isFavorite': false,
      'description': 'Stage en marketing digital pour apprendre les techniques de communication digitale et les stratégies marketing.',
      'requirements': ['Étudiant en marketing', 'Connaissance des réseaux sociaux', 'Créativité'],
      'benefits': ['Formation pratique', 'Encadrement personnalisé', 'Certificat de stage'],
    },
    {
      ...
      'isJob': true,
      'isFavorite': false,
      'description': 'Développement d\'applications web complètes avec technologies modernes.',
      'requirements': ['React/Node.js', 'Base de données', 'Docker', 'CI/CD'],
      'benefits': ['Projets variés', 'Technologies modernes', 'Formation continue'],
    },
  ];
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _buildHeaderStat('${widget.company['followers']}', 'Suiveurs', Icons.people),
  ...
  Widget _buildTabBar() {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _buildTabButton('Offres', selectedTab == 'Offres'),
          ),
          Expanded(
  ...
  Widget _buildTabButton(String title, bool isSelected) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? AppColors.blueDark.withValues(alpha: 0.1) : Colors.transparent,
          border: Border(
            bottom: BorderSide(
              color: isSelected ? AppColors.blueDark : Colors.grey.withValues(alpha: 0.3),
              width: 2,
            ),
          ),
        ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          ...companyOffers.map((offer) => _buildOfferCard(offer)).toList(),
        ],
      ),
    );
  }
        ...
        child: InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: Border(
                left: BorderSide(
                  color: offer['isJob'] ? AppColors.greenDark : AppColors.blueDark,
                  width: 4,
                ),
              ),
            ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Icon(
                          offer['isFavorite'] ? Icons.bookmark : Icons.bookmark_border,
                          color: offer['isFavorite'] ? Colors.amber : AppColors.secondaryText,
                          size: 24,
                        ),
                      ),
                  ...
                  Row(
                    children: [
                      ...
                      Row(
                        children: [
                          const Icon(Icons.description, size: 16, color: AppColors.blueDark),
                          const SizedBox(width: 4),
                          Text(
                            offer['type'],
                            style: GoogleFonts.roboto(
                      ...
                      Row(
                        children: [
                          const Icon(Icons.access_time, size: 16, color: AppColors.secondaryText),
                          const SizedBox(width: 4),
                          Text(
                            offer['time'],
                            style: GoogleFonts.roboto(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoCard('Taille de l\'entreprise', widget.company['employees']),
        ],
      ),
    );
  }
    ...
    setState(() {
      ...
      if (isFollowing) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Vous suivez maintenant ${widget.company['name']}', style: GoogleFonts.roboto()),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Vous ne suivez plus ${widget.company['name']}', style: GoogleFonts.roboto()),
    ...
    setState(() {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          backgroundColor: offer['isFavorite'] ? AppColors.greenDark : Colors.orange,
        ),
      );
    });
  }
