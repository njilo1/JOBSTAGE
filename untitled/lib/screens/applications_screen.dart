...
class _ApplicationsScreenState extends State<ApplicationsScreen> with TickerProviderStateMixin {
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(child: _buildAnimatedStatCard('Total', applications.length.toString(), AppColors.blueDark, Icons.assignment)),
                const SizedBox(width: 10),
                Expanded(child: _buildAnimatedStatCard('En cours', applications.where((a) => a['status'] == 'En cours').length.toString(), AppColors.orangeDark, Icons.schedule)),
                const SizedBox(width: 10),
                Expanded(child: _buildAnimatedStatCard('Acceptées', applications.where((a) => a['status'] == 'Acceptées').length.toString(), AppColors.greenDark, Icons.check_circle)),
              ],
            ),
          ),
          // Applications list
        ...
        child: Column(
          ...
          children: [
            ...
            LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(application['statusColor']),
            ),
            const SizedBox(height: 15),
            Row(
              children: [
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDetailRow('Date de candidature', application['appliedDate']),
  ...
  Widget _buildTimeline(Map<String, dynamic> application) {
    final steps = ['Candidature envoyée', 'CV examiné', 'Entretien RH', 'Entretien technique', 'Décision finale'];
        ...
        return Row(
          children: [
            Container(
              ...
              height: 20,
              decoration: BoxDecoration(
                color: isCompleted ? AppColors.greenDark : (isCurrent ? AppColors.orangeDark : Colors.grey[300]),
            ...
            Expanded(
              child: Text(
                ...
                style: GoogleFonts.roboto(
                  ...
                  color: isCompleted || isCurrent ? AppColors.primaryText : AppColors.secondaryText,
                ),
              ),
            ),
          ],
